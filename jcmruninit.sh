...
cd /fs/clip-scratch/jyothikv/jvdofs/expDir/eruns
mkdir $runID-wdir
...
do
  ...
  cp $wd/rcv1v2.$rCategory.labids.txt /fs/clip-ediscovery/jyothi/Research/jvdofs/mfpadat/rcv1v2.$rCategory.labids.txt
  chmod 774 /fs/clip-ediscovery/jyothi/Research/jvdofs/mfpadat/rcv1v2.$rCategory.labids.txt
